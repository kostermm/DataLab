...
Highcharts.setOptions({
	lang: {
		...
		// Specific text labels for drill maps
...
Highcharts.theme = {
	colors: categorie,
	/*colorPalettes: {
		categorie: ['#42145f','#ffb612','#a90061','#777c00','#007bc7','#673327','#e17000','#39870c', '#94710a','#01689b','#f9e11e','#76d2b6','#d52b1e','#8fcae7','#ca005d','#275937','#f092cd'],
		geslacht: ['#007bc7', '#ca005d', '#42145f'], //order: 1)men, 2)women, 3)total
		profiel: ['#e17000', '#42145f', '#777c00'],
		internationaal: ['#42145f', '#ffb612']
	},*/
	title: {
		align: 'center',
		style: {
